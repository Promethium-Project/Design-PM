...
Ces Anchors inférés ne pointent pas vers une _position_ dans un document, mais vers un autre Node entier. C'est une légère extension du modèle Anchor, où la `source_position` devient optionnelle quand l'Anchor relie deux Nodes entiers plutôt qu'une position à un Node.
